...
export declare const SystemEvents: {
    /** 模組初始化事件 */
    readonly MODULE_INITIALIZED: "system.module.initialized";
    /** 模組銷毀事件 */
    readonly MODULE_DESTROYED: "system.module.destroyed";
    /** 錯誤發生事件 */
    readonly ERROR_OCCURRED: "system.error.occurred";
    /** 快取更新事件 */
    readonly CACHE_UPDATED: "system.cache.updated";
    /** 快取失效事件 */
    readonly CACHE_INVALIDATED: "system.cache.invalidated";
    /** 檔案變更事件 */
    readonly FILE_CHANGED: "system.file.changed";
    /** 會話開始事件 */
    readonly SESSION_STARTED: "system.session.started";
    /** 會話結束事件 */
    readonly SESSION_ENDED: "system.session.ended";
};
/**
 * 模組初始化事件
 */
 ...
 * 所有系統事件的聯合類型
 */
export type SystemEvent = ModuleInitializedEvent | ModuleDestroyedEvent | ErrorOccurredEvent | CacheUpdatedEvent | CacheInvalidatedEvent | FileChangedEvent | SessionStartedEvent | SessionEndedEvent;
/**
 * 事件統計資訊
 */
