...
export class MoveService {
    importResolver;
    constructor(config, importResolver) {
        if (importResolver) {
     ...
     * 移動檔案或目錄
     */
    async moveFile(operation, options = {}) {
     ...
     * 驗證路徑
     */
    async validatePaths(source, target) {
        // 檢查來源是否存在
        try {
     ...
     * 應用路徑更新
     */
    async applyPathUpdates(updates) {
     ...
     * 應用單一檔案的更新
     */
    async applyFileUpdates(filePath, updates) {
        try {
