...
// 策略相關
export { LRUStrategy, LFUStrategy, FIFOStrategy, TTLStrategy, RandomStrategy, StrategyFactory } from './strategies.js';
// 型別定義
export { 
// 列舉
EvictionStrategy, CacheEventType } from './types.js';
// 常用的預設配置
 ...
 * 工廠函式：建立帶 TTL 的快取
 */
export function createTTLCache(defaultTTL, maxSize = 1000) {
    return createMemoryCache({
        maxSize,
        defaultTTL,
 ...
 */
export function createHighPerformanceCache(options) {
    return createMemoryCache({
