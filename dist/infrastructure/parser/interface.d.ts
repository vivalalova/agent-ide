 ...
 */
export declare function isParserPlugin(value: unknown): value is ParserPlugin;
/**
 * 檢查插件是否支援特定副檔名
 */
export declare function supportsExtension(plugin: ParserPlugin, extension: string): boolean;
/**
 * 檢查插件是否支援特定語言
 */
export declare function supportsLanguage(plugin: ParserPlugin, language: string): boolean;
/**
 * 從檔案路徑獲取副檔名
 */
 ...
 * 查找可以處理特定檔案的插件
 */
export declare function findPluginForFile(plugins: ParserPlugin[], filePath: string): ParserPlugin | null;
